    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anio_ingreso', models.IntegerField(blank=True, null=True, verbose_name='A\xf1o ingreso')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('costo_produccion', models.FloatField(verbose_name='Costo de producci\xf3n (Inversi\xf3n) C$/Mz')),
                ('ingresos_produccion', models.FloatField(verbose_name='Ingresos de la producci\xf3n C$/Mz')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('respuesta', multiselectfield.db.fields.MultiSelectField(choices=[('Intermediario', 'Intermediario'), ('Al estado', 'Al estado'), ('Consumidor / Mercado local', 'Consumidor / Mercado local'), ('Mercado nacional', 'Mercado nacional'), ('Exportaci\xf3n', 'Exportaci\xf3n')], max_length=79)),
                ('encuesta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='productores.Encuesta')),
            ],
            options={
